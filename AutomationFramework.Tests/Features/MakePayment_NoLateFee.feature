Feature: Make a Payment without Late Fee
  ...
  Scenario: HAP-700 TS-001 TC-001 - Make a Payment with no late fee message
    When I select the applicable loan account from test data "HAP-700 TS-001 TC-001"
    ...
    And I select the payment date from test data "HAP-700 TS-001 TC-001"
